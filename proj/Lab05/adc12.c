...
void ADC0_init(void) {
    ...
    IOMUX->SECCFG.PINCM[IOMUX_PINCM60] = (IOMUX_PINCM_PC_CONNECTED);
    ...
    ADC0->ULLMEM.CTL0 = 0;
    ADC0->ULLMEM.CTL0 |= ADC12_CTL0_PWRDN_MANUAL;       // enable power
    ADC0->ULLMEM.CTL0 |= ADC12_CTL0_ENC_ON;					   // one-shot conversion
