...
void TIMG0_init(uint32_t period, uint32_t prescaler) {
    ...
    TIMG0->COUNTERREGS.CTRCTL = GPTIMER_CTRCTL_CM_DOWN | GPTIMER_CTRCTL_CVAE_LDVAL | GPTIMER_CTRCTL_REPEAT_REPEAT_1;
...
void TIMG12_init(uint32_t period) {
    ...
    TIMG12->COUNTERREGS.CTRCTL = GPTIMER_CTRCTL_CM_DOWN | GPTIMER_CTRCTL_CVAE_LDVAL | GPTIMER_CTRCTL_REPEAT_REPEAT_1;
